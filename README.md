...
| Addon | Beschreibung | Build-Repo |
|---|---|---|
| [Grafana](grafana/) | Grafana Analytics- und Monitoring-Plattform | [ha-addons-grafana](https://github.com/bborchers/ha-addons-grafana) |
...
3. **Tabellenzeile** in diesem README ergänzen.
