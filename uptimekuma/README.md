...
[![license](https://img.shields.io/github/license/bborchers/ha-addons-uptimekuma)](https://github.com/bborchers/ha-addons-uptimekuma/blob/main/LICENSE)
...
See [DOCS.md](DOCS.md) for installation and configuration. Source code and issues: [ha-addons-uptimekuma](https://github.com/bborchers/ha-addons-uptimekuma).
